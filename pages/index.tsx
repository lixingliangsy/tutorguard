...
function buildDemoSteps(): DemoStep[] {
  ...
  return [
    ...
    },
    {
      ...
      detail: inputLines.length ? inputLines.join('\n') : `Describe the tutor and arrangement in the studio.`,
    },
    {
      title: `Click “${cta}”`,
  ...
  async function runStudio(e?: FormEvent) {
    ...
    try {
      const r = await fetch('/api/tool', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ useMock: useDemoMode, inputs: form, action: 'start', step: 'ingest' }),
      })
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://tutorguard.lxsaihub.com/" />
      </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section className="bg-slate-950 text-white py-10">
          <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[['5', 'Safety rules'], ['ID', 'Verified'], ['<2 min', 'To plan'], ['Monitor', 'Continuous']].map(([n, l]) => (
              <div key={l}>
        ...
        <section id="features" className="py-20">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold mb-3">Vet any tutor before you trust them</h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
              {featCards.map((f) => (
                <div key={f} className="rounded-2xl border border-slate-200 p-6 shadow-sm hover:-translate-y-1 transition bg-white">
                  ...
                  <p className="text-sm text-slate-600">Built for parents who want a clear safety read without hiring an agency.</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="how" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-extrabold">From arrangement to plan in 3 steps</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ['1', 'Capture', 'Describe the tutor, the student age, and your main concerns.'],
                ['2', 'Screen', 'Rule-based safeguarding checks (TG-01..05), then model-assisted guidance.'],
                ['3', 'Plan', 'Export a parent safety action plan with runId.'],
              ].map(([n, t, d]) => (
        ...
        <section id="studio" className="py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <form onSubmit={runStudio} className="rounded-2xl border border-slate-200 p-6 bg-white shadow-sm">
                <h3 className="font-bold mb-4">Tutor safety check</h3>
                {inputsSchema.map((f) => (
          ...
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-4">Trusted by parents and tutoring ops</h2>
            <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">
              Social proof uses templates until real, consented testimonials exist. Trusted by <strong>[X]+</strong> parents and tutoring agencies.
            </p>
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-3">
              {[
                ...
                ['Is this a replacement for vetting?', 'No. TutorGuard is decision-support: rule-based checks plus model-assisted guidance. Always complete your own due diligence (ID, references, interviews) before trusting a tutor with a child.'],
              ].map(([q, a]) => (
        ...
        <section className="py-20">
          <div id="signup" className="max-w-3xl mx-auto px-6 text-center rounded-3xl bg-slate-950 text-white p-10">
            <h2 className="text-3xl font-extrabold mb-3">Keep tutoring safe</h2>
            <p className="text-slate-300 mb-6">Join parents using {PRODUCT.name}. Free to try — no card needed.</p>
